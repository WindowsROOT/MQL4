<table>
    <tbody><tr>
        ...
        <tr>
            ...
            <td>
                <input name="Period" type="number" value="20">
                &nbsp;
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input name="Deviation" type="number" value="2">
                &nbsp;
                &nbsp;
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input name="Bands_Shift" type="number" value="0">
                &nbsp;
                &nbsp;
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <select name="Mode">
                    ...
                    <option value="MODE_UPPER">MODE_UPPER</option>
