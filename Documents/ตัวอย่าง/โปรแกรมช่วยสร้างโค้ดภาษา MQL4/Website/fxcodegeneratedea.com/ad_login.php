        ...
        <div class="row" id="pwd-container">
            ...
            <div class="col-md-4">
                <section class="login-form">
                    <form method="post" action="c_check_login_ad.php" role="login">
                        <img src="http://i.imgur.com/RcmcLv4.png" class="img-responsive" alt="" />
                        <input type="text" name="username1" placeholder="Email" required class="form-control input-lg" value="" />
                        ...
                        <button type="submit" name="go" class="btn btn-lg btn-primary btn-block">เข้าสู่ระบบ</button>
